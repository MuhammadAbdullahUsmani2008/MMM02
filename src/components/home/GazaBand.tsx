          ...
          <Reveal delay={100} className="lg:col-span-5 lg:pl-6">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-2 sm:gap-4">
              <Link
                ...
                className="group inline-flex flex-1 sm:flex-none items-center justify-center gap-1 rounded-full bg-[#075BD6] min-h-[38px] px-1.5 py-1.5 xs:px-2 xs:py-2 sm:min-h-[44px] sm:px-6 sm:py-3.5 font-display text-[0.5625rem] xs:text-[0.6rem] sm:text-[0.96rem] font-bold text-white shadow-sm transition-all duration-250 hover:bg-[#e53935] hover:shadow-md active:scale-98"
              >
                <span className="whitespace-nowrap">Support the Gaza relief effort</span>
                <Arrow className="h-2.5 w-2.5 shrink-0 transition-transform duration-300 group-hover:translate-x-1.5" />
              </Link>
              <Link
                href="/donate"
                className="inline-flex flex-1 sm:flex-none min-h-[38px] items-center justify-center font-display text-[0.5625rem] xs:text-[0.6rem] sm:text-[0.92rem] font-bold text-[#075BD6] hover:text-[#e53935] transition-colors underline underline-offset-4 whitespace-nowrap"
              >
